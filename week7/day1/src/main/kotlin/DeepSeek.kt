...
/** Простая обёртка над DeepSeek chat/completions. */
class DeepSeekClient(private val apiKey: String, private val model: String) {
    ...
    fun chat(messages: List<Msg>, temperature: Double = 0.2, maxTokens: Int = 512): String {
        require(apiKey.isNotBlank()) {
            "DEEPSEEK_API_KEY не задан — положи в env или в .env корня репо."
        }
        val body = mapOf(
            "model" to model,
